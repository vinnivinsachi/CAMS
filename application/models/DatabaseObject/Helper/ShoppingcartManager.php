<?php
	...
	class DatabaseObject_Helper_ShoppingcartManager extends DatabaseObject
	{
		...
		public static function emptyCartProfileSimpleBeforeReenterCheckoutInsertion($db, $order_unique_id){
			
				$db->delete('shopping_cart_profile_simple', "order_unique_id = '".$order_unique_id."'");
