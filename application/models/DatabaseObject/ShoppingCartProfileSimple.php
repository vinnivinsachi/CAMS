<?php
	class DatabaseObject_ShoppingCartProfileSimple extends DatabaseObject
	{
		public $productShippingAddress=null;
		public $profile =null;
		
		public function __construct($db){
			parent::__construct($db, 'shopping_cart_profile_simple', 'shopping_cart_profile_simple_id');
