<?php
	...
	class DatabaseObject_Products extends DatabaseObject
	{
		...
		public function setImageOrder($order){	
			$this->getImages();
			//echo 'here at setting productlistings';
			//Zend_Debug::dump($this->images);
			foreach($this->images as $k=>$v){
			$imagesArray[$v['image_id']]=$v['image_id'];
			}
			DatabaseObject_Helper_ProductListing::setImageOrder($this->_db, 'product_images', $order, $imagesArray);
		}	
	}
?>