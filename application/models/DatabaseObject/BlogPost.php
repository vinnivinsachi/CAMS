<?php
	...
	class DatabaseObject_BlogPost extends DatabaseObject
	{
		...
		{
			//echo $this->uploader_id;
			$this->url = DatabaseObject_StaticUtility::generateUniqueUrl($this->_db, $this->_table, $this->profile->title,  $this->uploader_id);
