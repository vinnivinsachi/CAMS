<?php
	...
	class FormProcessor_BlogPost extends FormProcessor
	{
		...
		public function process(Zend_Controller_Request_Abstract $request)
		{
			...
			$this->title = $request->getPost('username');
			...
			$this->title_tag = $this->sanitize($request->getPost('title_tag'));
			...
			$this->language = $request->getPost('language');
