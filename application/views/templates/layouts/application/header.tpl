        ...
        <div id="scroller">
            ...
            <div id='header' style="float:left;">
                ...
                <div id="headerMenu">
                   ...
                   <a href="{geturl controller='index'}?category=Treatments">Treatments</a>  
                   ...
                   <a href="{geturl controller='index'}?category=Testimonials">Testimonials</a>
                   <a href="{geturl controller='index'}?category=Resources">Resources</a>
                   <a href="{geturl controller='index'}?category=Contact Us">Contact Us</a>


                 <!-- 
                    New links here...
                   <a href="{geturl controller='index'}?category=Blah">Blah</a>
