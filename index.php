...
/*try{*/
	...
	$writer=new EmailLogger('vedance@gmail.com');
...
$writer->setEmail('vedance.info@gmail.com');
...
$route = new Zend_Controller_Router_Route('policiesandreturns', array('controller'=>'index', 'action'=>'policiesandreturns'));
$controller->getRouter()->addRoute('policiesandreturns', $route);

$route = new Zend_Controller_Router_Route('faq', array('controller'=>'index', 'action'=>'faq'));
$controller->getRouter()->addRoute('faq', $route);
