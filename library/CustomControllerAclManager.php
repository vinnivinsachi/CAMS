<?php
	class CustomControllerAclManager extends Zend_Controller_Plugin_abstract
	{
		...
		public function __construct(Zend_Auth $auth)
		{
			...
			$this->acl->allow(null, 'ordermanager', array('guestorders'));
			...
			$this->acl->allow('member', 'account', array('index', 'login', 'fetchpassword' ,'logout', 'verifyselleraccount', 'messages', 'details', 'rewardpoints', 'editbasicinfo', 'editshipping', 'deleteshipping', 'makedefaultshipping', 'upgradegeneralseller', 'upgradestoreseller', 'uploadmeasurement', 'images', 'verifyselleraccount', 'applyforpromotioncode'));
			...
			$this->acl->allow('storeSeller', 'eventmanager');

			$this->acl->allow('guest', 'checkout', array('index'));
			...
			$this->acl->allow('storeSeller', 'adminaccount');
			
			$this->acl->allow('storeSeller', 'orderadministration');
			
			$this->acl->allow('storeSeller', 'blogmanager');
			
			$this->acl->allow('storeSeller', 'newsletter');
		}
